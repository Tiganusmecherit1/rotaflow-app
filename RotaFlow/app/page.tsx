...
const SHIFT_STYLE: Record<string, string> = {
  D:  'bg-amber-600/90 text-orange-50 border border-orange-400/60',
  S:  'bg-blue-900/90 text-blue-50 border border-blue-400/50',
  ...
  const generatePDF = (lunaRef?: Date) => {
    ...
    autoTable(doc, {
      ...
      didParseCell: (data) => {
        ...
        if(!isCTAView && v==='Z') { data.cell.styles.fillColor=[217,119,6]; data.cell.styles.textColor=[255,247,237]; } // PLO Zi (8h) — galben-portocaliu, ca-n aplicatie
        else if(!isCTAView && v==='N') { data.cell.styles.fillColor=[30,58,138]; data.cell.styles.textColor=[239,246,255]; } // PLO Noapte (8h) — safir, ca-n aplicatie
            ...
            <div className="bg-[#2c2c2e] border border-white/[0.07] rounded-xl overflow-hidden">
              ...
              <div className="px-4 py-3 border-t border-white/[0.05] flex gap-5 flex-wrap items-center">
                {locatieActiva === 'PLO' ? (
                  ...
                  <>
                    <div className="flex items-center gap-2 text-[12px] text-zinc-400"><div className="w-4 h-4 rounded-md bg-amber-600/90 border border-orange-400/60 flex items-center justify-center text-[9px] font-black text-orange-50">Z</div>Zi</div>
                    <div className="flex items-center gap-2 text-[12px] text-zinc-400"><div className="w-4 h-4 rounded-md bg-blue-900/90 border border-blue-400/50 flex items-center justify-center text-[9px] font-black text-blue-50">N</div>Noapte</div>
